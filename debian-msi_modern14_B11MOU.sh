...
sudo apt install -y xfce4-power-manager tlp redshift  fcitx-unikey flameshot 
...
# Packages needed for bspwm installation and polybar
sudo apt install -y bspwm dmenu sxhkd picom numlockx rofi dunst libnotify-bin unzip geany polybar
